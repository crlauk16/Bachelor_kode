...
//  Serial.println(latHel);
//  Serial.println(latDec1);
//  Serial.println(latDec2);
//  Serial.println(latDec3);
//  Serial.println(lngHel);
//  Serial.println(lngDec1);
//  Serial.println(lngDec2);
