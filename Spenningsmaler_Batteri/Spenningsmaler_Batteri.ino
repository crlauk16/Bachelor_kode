...
void loop()
{
    ...
    voltage = ((float)sum / (float)NUM_SAMPLES * 5.030) / 1024.0; //Må bruke batteri som Vin, ikke bare PCen. Ellers viser spenningen 0,1V feil.
    // send voltage for display on Serial Monitor
    // voltage multiplied by 11 when using voltage divider that
    // divides by 11. 11.132 is the calibrated voltage divide
    // value
    Serial.println(voltage * 3.127659574);
    sample_count = 0;
    sum = 0;
}
